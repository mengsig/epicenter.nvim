...
Supertypes, subtypes and implementors of the type under the cursor, in three
groups. A supertype expands upward, a subtype downward.

Both ride the standard LSP call- and type-hierarchy methods the v1.1 protocol
