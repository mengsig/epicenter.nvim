...
describe("events", function()
  ...
  it("exposes no dead event constants nothing ever emits (F10)", function()
    expect.eq(events.ATTACHED, nil, "EpicenterAttached was never emitted anywhere")
    expect.eq(events.DETACHED, nil, "EpicenterDetached was never emitted anywhere")
  end)
end)
